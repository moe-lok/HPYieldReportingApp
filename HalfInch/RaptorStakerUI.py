...
class RaptorStaker(tk.Frame):
    # Column name of table
    fieldsLeft = ('Operator', 'Reel ID', 'Qty In', 'Qty Out')
    fieldsRight = ('Corner Lift', 'Delamination', 'Crush Tip', 'Crack Die', 'Engineering Scrap', 'Production Scrap',
                   'Others', 'Remarks')
    ...
    def __init__(self, root, strFileDir):
        ...
        SHEET_NAME = "RT Staker"

        TarCoverlayerYieldTarget = 99.68
        ...
        colDict = {
            ...
            "colCrushTip": "K",
            "colCrackDie": "L",
            "colEngineeringScrap": "M",
            "colProductionScrap": "N",
            "colOthers": "O",
            "colRemarks": "P"
        }

...
class TarzanCapAttach(tk.Frame):
    # Column name of table
    fieldsLeft = ('Operator', 'Reel ID', 'Qty In', 'Qty Out')
    fieldsRight = ('Incoming Reject Part', 'No Die on Incoming “Good” Part', 'Adhesive outside outer area Reject',
                   "Adhesive dot too small Reject", "Cap Placement Reject – no capacitor", "Pre Cure Inspect Reject",
                   "Cure Station Reject – incompletely/not cured", "E-Test Reject – Open", "E-Test Reject – Short",
                   "E-Test Reject – Capacitance OOS", "Post Cure Inspect Reject", "Production Reject ", "Remarks"
                   )
    ...
    def __init__(self, root, strFileDir):
        ...
        SHEET_NAME = "Tarzan Cap Attach"

        TarCapAttachYieldTarget = 99.4
        ...
        colDict = {
            ...
            "colNoDieIncomingGoodPart": "J",
            "colAdhOutsideOuterAreaRej": "K",
            "colAdhTooSmallRej": "L",
            "colCapPlacementRej": "M",
            "colPreCureInspectRej": "N",
            "colCureStationRej": "O",
            "colEtestRejOpen": "P",
            "colEtestRejShort": "Q",
            "colEtestRejCapOOS": "R",
            "colPostCureInspectRej": "S",
            "colProdRej": "T",
            "colRemarks": "U"
        }
        ...
        def calculateYield():
            ...
            try:
                ...
                if round(result, 2) < TarCapAttachYieldTarget:

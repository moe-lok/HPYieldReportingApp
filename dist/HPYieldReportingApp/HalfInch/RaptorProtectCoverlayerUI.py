...
class RaptorProtectCoverlayer(tk.Frame):
    # Column name of table
    fieldsLeft = ('Operator', 'Reel ID', 'Qty In', 'Qty Out')
    fieldsRight = ('CVLR Missing', 'CVLR Waste', 'Contam', 'Bad Tack', 'PET Misalign', 'Bubble', 'Wrinkles', 'Others',
                   'Remarks')
    ...
    def __init__(self, root, strFileDir):
        ...
        SHEET_NAME = "RT Protect Coverlayer"

        TarCoverlayerYieldTarget = 99.0
